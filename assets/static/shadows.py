...
SHADOW_RESET1 = QGraphicsDropShadowEffect(xOffset=5, yOffset=5, blurRadius=10)
SHADOW_CALC1 = QGraphicsDropShadowEffect(xOffset=5, yOffset=5, blurRadius=10)
SHADOW_GOBACK1 = QGraphicsDropShadowEffect(xOffset=5, yOffset=5, blurRadius=10)
SHADOW_ACCEPT = QGraphicsDropShadowEffect(xOffset=5, yOffset=5, blurRadius=10)
